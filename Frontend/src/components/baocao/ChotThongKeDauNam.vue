  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6"><h1 class="m-0">Quản Lý Chốt Tồn Kho</h1></div>
        </div>
      </div>
    </div>
                ...
                <div class="mt-4" v-if="reportData.length > 0">
                  ...
                  <div class="table-responsive" style="max-height: 500px;">
                    <table class="table table-bordered table-striped table-head-fixed text-nowrap">
                      <thead>
                        <tr>
                          <th>Stt</th><th>Mã SP</th><th>Tên SP</th><th>ĐVT</th>
                      ...
                      <tbody>
                          ...
                          <tr v-if="reportData.length > 0" class="bg-warning font-weight-bold" style="background-color: #fff3cd !important;">
              ...
              <div class="tab-pane fade" :class="{ 'show active': activeTab === 'history' }">
                ...
                <div class="mt-4" v-if="historyData.length > 0">
                  ...
                  <div class="table-responsive" style="max-height: 500px;">
                    <table class="table table-bordered table-striped table-head-fixed text-nowrap">
                      ...
                      <tbody>
                          ...
                          <tr v-if="historyData.length > 0" class="bg-primary font-weight-bold" style="background-color: #cce5ff !important; color: #004085;">
                          <td colspan="4" class="text-center">TỔNG CỘNG</td>
                          <td class="text-right">{{ grandTotal.tdk }}</td>
                          <td class="text-right">{{ grandTotal.ntk }}</td>
                          <td class="text-right">{{ grandTotal.xtk }}</td>
                 ...
                 <div v-else-if="searchedHistory" class="text-center mt-5 text-muted">
                    <p><i class="fas fa-search mb-2" style="font-size: 2rem;"></i><br>Không tìm thấy dữ liệu chốt sổ cho năm/kho này.</p>
                </div>
